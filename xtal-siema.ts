export interface IXtalSiemaProperties{
    duration: number | polymer.PropObjectType,
    easing: string | polymer.PropObjectType,
    perPage: number | object | polymer.PropObjectType,
    startIndex: number | polymer.PropObjectType,
